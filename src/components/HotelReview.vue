    ...
    <div class="pt-3">
      ...
      <div class="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
        <div class="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
          <img :src="hotel.images[0].url" :alt="hotel.images[0].altText" class="w-full h-full object-center object-cover" />
        </div>
        <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
          <div class="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
            <img :src="hotel.images[1].url" :alt="hotel.images[1].allText" class="w-full h-full object-center object-cover" />
          </div>
          <div class="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
            <img :src="hotel.images[3].url" :alt="hotel.images[3].altText" class="w-full h-full object-center object-cover" />
          </div>
        </div>
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          ...
          <div v-if="hotel.starRating" class="mt-2">
            ...
            <div class="flex items-center justify-between">
              ...
              <div>
                <button class="rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500" @click="addWishList">
